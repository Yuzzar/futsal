...
<head>
    <title>Profil | Futsal Setia</title>
...
<body>
    ...
    <header>
        <h2><a href=" #">Futsal Setia</a></h2>
        <nav>
            <li><a href="/">Home</a></li>
            <li><a href="#services">Bookings</a></li>
            <li><a href="#maps">Transaksi</a></li>
    ...
    <section class="maps" id="maps">
        <h3 class="header-text">Setia Venue</h3>
        <p>Lokasi Futsal Setia tersebar pada beberapa lokasi </p>
